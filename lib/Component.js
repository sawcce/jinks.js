 ...
 * flickers.
 */
function smartReplace(nodes, replacements) {
...
function similarNodesReplace(node, newNode) {
	...
	if (areNodesEqual) {
		smartReplace(node.childNodes, newNode.childNodes);
...
export class ComponentInstance {
	...
	/// If the component is being rendered
	isRendering = false;
	/// If the component's state has been modified during rendering
	wasModified = false;
